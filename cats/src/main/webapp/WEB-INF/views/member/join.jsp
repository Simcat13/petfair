		...
		var state = {
			...
			ok : function() {
				return this.memberIdValid && this.memberPwValid
						&& this.memberPwCheckValid && this.memberNameValid
						&& this.memberEmailValid && this.memberContactValid
						&& this.memberBirthValid && this.memberAddValid;
...
<div class="container w-600">
		...
		<div class="cell center p-5">
			<h3 class="center">
				<i class="fa-solid fa-user"></i> 회원가입 (회원용)
			</h3>
		</div>
		...
		<div class="cell area1 mt-4">
			<div class="w-30">
				<label> 이름 <i class="fa-solid fa-asterisk red"></i>
				</label>
			</div>
			<div class="w-70">	
	...
	<script>
		...
		<div class="cell area1 mt-4">
			...
			<div class="w-70">		
				<input type="checkbox"
					class="agreeCheckbox" oninput="checkAgreeRequired();" name="memberAgree" value="Y">
				<label>[필수]</label>			
				<span>
		...
		<div class="cell area1 mt-4">
			<div class="w-30">
				<label>이벤트 수신 동의</label>
			</div>
			<div class="w-70">				
				<input type="checkbox" name="memberEvent" value="Y">
				<label>[선택]</label>
