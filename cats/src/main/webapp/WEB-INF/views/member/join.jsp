...
<div class="row mt-4">
	<div class="col">
		<div class="center">
			<label class="col-1">개인정보 동의</label>
			<input type="checkbox" class="agreeCheckbox" oninput="checkAgreeRequired();">
			<span>
				<a class="col-2" data-toggle="modal" data-target="#privacyPolicyModal" style="cursor:pointer">개인정보 수집 및 이용</a>
				에 동의합니다.
			</span>
		</div>
	</div>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <p class="modal-title" id="privacyPolicyModalLabel" style="font-size: 1.2rem;
    				line-height: 26px; font-weight: 700; color: #1c1e22;">개인정보처리방침</p>
                <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p class="joinAgreeTitle">제1조(목적)</p>
                <p class="joinAgreeContent">
                	<span style="font-weight: bold; text-decoration:underline; font-size: 13px">(주)야옹</span>
                	(이하 ‘회사'라고 함)은 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하 ‘이용자’ 또는 ‘개인’)의 정보(이하 ‘개인정보’)를 보호하기 위해, 
                	개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 ‘본 방침’)을 수립합니다.
                </p>
                <br>
                ...
                <p class="joinAgreeContent">회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 회사 홈페이지 첫 화면 또는 첫 화면과의 연결화면을 통해 본 방침을 공개하고 있습니다.
					회사는 제1항에 따라 본 방침을 공개하는 경우 글자 크기, 색상 등을 활용하여 이용자가 본 방침을 쉽게 확인할 수 있도록 합니다.</p>
				<br>
                <p class="joinAgreeTitle">제4조(본 방침의 변경)</p>
                <p class="joinAgreeContent">본 방침은 개인정보 관련 법령, 지침, 고시 또는 정부나 회사 서비스의 정책이나 내용의 변경에 따라 개정될 수 있습니다. 
                	...
                	다만, 이용자 권리의 중요한 변경이 있을 경우에는 최소 30일 전에 공지합니다.</p>
                <br>
                <p class="joinAgreeTitle">제5조(회사 서비스 제공을 위한 정보)</p>
                <p class="joinAgreeContent">회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다. 
                	필수 수집 정보: 이메일 주소, 이름 및 연락처</p>
                <br>
                ...
                <p class="joinAgreeContent">회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.
					...
					이용자가 공고 지원을 위해 회사의 서비스를 이용하는 과정에서 이용자가 입력 하는 방식</p>
				<br>
                <p class="joinAgreeTitle">제7조(개인정보의 이용)</p>
                <p class="joinAgreeContent">회사는 개인정보를 다음 각 호의 경우에 이용합니다.
					...
					신규 서비스 개발을 위한 경우
					이벤트 및 행사 안내 등 마케팅을 위한 경우 채용 절차 진행을 위해 안내 메일 및 문자를 발송하는 경우</p>
                <br>
                <p class="joinAgreeTitle">제8조(개인정보의 보유 및 이용기간)</p>
                <p class="joinAgreeContent">회사는 이용자의 개인정보에 대해 개인정보의 수집·이용 목적 달성을 위한 기간 동안 개인정보를 보유 및 이용합니다.
                ...
                <p class="joinAgreeContent">회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.
                ...
                <p class="joinAgreeContent">회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않을 경우에는 해당 정보를 지체 없이 파기합니다.</p>
                <br>
                <p class="joinAgreeTitle">제11조(개인정보파기절차)</p>
                <p class="joinAgreeContent">이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기 되어집니다.
					회사는 파기 사유가 발생한 개인정보를 개인정보보호 책임자의 승인절차를 거쳐 파기합니다.</p>
                <br>
                <p class="joinAgreeTitle">제12조(개인정보파기방법)</p>
                <p class="joinAgreeContent">회사는 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제하며, 종이로 출력된 개인정보는 분쇄기로 분쇄하거나 소각 등을 통하여 파기합니다.</p>
                <br>
                <p class="joinAgreeTitle">제13조(광고성 정보의 전송 조치)</p>
                <p class="joinAgreeContent">회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전동의를 받습니다. 다만, 다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다
                ...
                <p class="joinAgreeContent">회사는 만 14세 미만 아동의 개인정보 보호를 위하여 만 14세 이상의 이용자에 한하여 회원가입을 허용합니다.
					제1항에도 불구하고 회사는 이용자가 만 14세 미만의 아동일 경우에는, 그 아동의 법정대리인으로부터 그 아동의 개인정보 수집, 이용, 제공 등의 동의를 그 아동의 법정대리인으로부터 받습니다.
					제2항의 경우 회사는 그 법정대리인의 이름, 생년월일, 성별, 중복가입확인정보(ID), 휴대폰 번호 등을 추가로 수집합니다.</p>
                <br>
                <p class="joinAgreeTitle">제15조(이용자의 의무)</p>
                <p class="joinAgreeContent">이용자는 자신의 개인정보를 최신의 상태로 유지해야 하며, 이용자의 부정확한 정보 입력으로 발생하는 문제의 책임은 이용자 자신에게 있습니다.
					타인의 개인정보를 도용한 회원가입의 경우 이용자 자격을 상실하거나 관련 개인정보보호 법령에 의해 처벌받을 수 있습니다.
					이용자는 전자우편주소, 비밀번호 등에 대한 보안을 유지할 책임이 있으며 제3자에게 이를 양도하거나 대여할 수 없습니다.</p>
                <br>
                <p class="joinAgreeTitle">제16조(회사의 개인정보 관리)</p>
                <p class="joinAgreeContent">회사는 이용자의 개인정보를 처리함에 있어 개인정보가 분실, 도난, 유출, 변조, 훼손 등이 되지 아니하도록 안전성을 확보하기 위하여 필요한 기술적·관리적 보호대책을 강구하고 있습니다.</p>
                <br>
                <p class="joinAgreeTitle">제17조(삭제된 정보의 처리)</p>
                <p class="joinAgreeContent">회사는 이용자 혹은 법정 대리인의 요청에 의해 해지 또는 삭제된 개인정보는 회사가 수집하는 "개인정보의 보유 및 이용기간"에 명시된 바에 따라 처리하고 그 외의 용도로 열람 또는 이용할 수 없도록 처리하고 있습니다.</p>
                <br>
                <p class="joinAgreeTitle">제18조(비밀번호의 암호화)</p>
                <p class="joinAgreeContent">이용자의 비밀번호는 일방향 암호화하여 저장 및 관리되고 있으며, 개인정보의 확인, 변경은 비밀번호를 알고 있는 본인에 의해서만 가능합니다.</p>
                <br>
                <p class="joinAgreeTitle">제19조(국외 이전 개인정보의 보호)</p>
                <p class="joinAgreeContent">회사는 이용자의 개인정보에 관하여 개인정보보호법 등 관계 법규를 위반하는 사항을 내용으로 하는 국제계약을 체결하지 않습니다.
                ...
                <br>
                <p class="joinAgreeTitle">제20조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</p>
                <p class="joinAgreeContent">회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정보 자동 수집장치(이하 '쿠키')를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 웹브라우저(PC 및 모바일을 포함)에게 보내는 소량의 정보이며 이용자의 저장공간에 저장되기도 합니다.  
