...
<script type="text/javascript">
    $(function() {
        $(".searchSelect").select2({
            minimumResultsForSearch: Infinity // select 창에 검색 바 유무 (주석 처리 시 생김)
        });
    });
</script>
            ...
            <div class="collapse navbar-collapse ps-5 ms-5" id="navbarColor03">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">관람안내</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">입장안내</a>
                            <a class="dropdown-item" href="#">사전등록</a>
                            <a class="dropdown-item" href="#">오시는길</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">커뮤니티</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">자유게시판</a>
                            <a class="dropdown-item" href="#">내새끼 자랑</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#">박람회 일정</a>
                            <a class="dropdown-item" href="#">공지사항</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">이용후기</a>
                        <div class="dropdown-menu">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">참가신청</a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#">개인사업자 참가신청</a>
                            <a class="dropdown-item" href="#">참가일정 확인</a>
                            <a class="dropdown-item" href="#">Something else here</a>
                        </div>
                    </li>
                </ul>
