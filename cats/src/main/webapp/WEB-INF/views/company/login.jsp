...
<div class="container center mt-4 pt-5">
		<div class="row mt-4">
			<div class="col">
				<i class="fa-solid fa-building"></i> 로그인
			</div>
		</div>
...
<div class="cell center">
		<a href="${pageContext.request.contextPath}/member/login">
			<button class="btn" title="유저 로그인 하러가기">
...
<div class="cell center mt-4">
	...
	&nbsp;|&nbsp;
	<a href="${pageContext.request.contextPath}/company/join" style="text-decoration-line: none;">회원가입</a>
</div>
